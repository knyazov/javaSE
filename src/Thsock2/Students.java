...
public class Students {
    public static GUIsecond.Students[] list_student;
    private int id;
    private String name;
    private String surname;
    private String faculty;
    private String group;
    public ArrayList<GUIsecond.Students> list_students = new ArrayList<>();
    public Students() {
    }
...
//        list_students.add(s);
    ...
    public void add_stud_list(GUIsecond.Students students){
